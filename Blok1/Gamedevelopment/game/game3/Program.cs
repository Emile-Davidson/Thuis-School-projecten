    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (playerWins < playerWinsEnd)
            {
                ...
                // L4 - Show the graphic:
                for(int goblin = 0; goblin < graphicGoblin.Length; goblin++ ){
                    Console.WriteLine(graphicGoblin[goblin]);
                }
            }
            else
            {
                ...
                // L4 - Show the graphic:
                for(int demon = 0; demon < graphicDemon.Length; demon++ ){
                    Console.WriteLine(graphicDemon[demon]);
                }
            }
