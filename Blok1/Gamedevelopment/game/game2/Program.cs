...
namespace _Eindresultaat
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ConsoleColor monsterColor = ConsoleColor.DarkGreen;
            bool monsterInit   = true;  // Sets monster health before battle starts

            ConsoleColor[] colorlist = {ConsoleColor.DarkBlue, ConsoleColor.Red, ConsoleColor.DarkGray, ConsoleColor.DarkMagenta};
            string[] namelist = {"rob", "bob", "sam", "rem", "kirikiri"};
            //  MONSTER PRITE ARRAY
            string[] monsterspits = 
            {
            "                        ",
            ...
            if (monsterInit)
            {
                monsterHealth = 30;
                monsterAttack = 5;
                monsterName = namelist[ randomNum.Next(0, namelist.Length)];
                monsterColor = colorlist[ randomNum.Next(0, colorlist.Length)]; 
                monsterInit = false;
            ...
            // Random colour:
            Console.ForegroundColor = monsterColor; // L3

            // L3 - Show the graphic:
            Console.WriteLine(monsterspits[0]);
            Console.WriteLine(monsterspits[1]);
            Console.WriteLine(monsterspits[2]);
            Console.WriteLine(monsterspits[3]);
            Console.WriteLine(monsterspits[4]);
            Console.WriteLine(monsterspits[5]);
